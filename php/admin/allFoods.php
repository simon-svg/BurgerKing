...
<body >
    ...
    <div class="admin">
        <nav id="sidebar-admin">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a class="admin__item" href="#">All Foods</a>
                </li>
                <li>
        ...
        <div class="admin__section admin__section_header-list">
            <div class="admin__section_head">
                <h3 class="admin__section_title">All Foods</h3>
            </div>
	...
	<script>
		$('option[value="<?php echo $categoriesId ?>"]').attr('selected', true);
	</script>
</body>
