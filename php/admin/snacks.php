                ...
                <div class="admin__section_content">
                    <div class="admin__burgers">
                        <table class="admin__table">
                            ...
                            <?php
                            $query = "SELECT * FROM all_foods WHERE categories_id = 2";
                            ...
                            ?>
                                <tr class="admin__section_item">
                                    ...
                                    <td class="admin__section_item_td">
                                        ...
                                        <a href="./snacks/remove.php?id=<?php echo $row["id"] ?>">
                    ...
                    ?>
                    <form class="admin__form" action="<?php if($_GET['id']){echo './snacks/update.php?id=' . $id;}else{echo './snacks/insert.php';} ?>" method="POST" enctype="multipart/form-data">
                        <div class="form__flex">
                            ...
                            <select name="categoriesId" id="categoriesId" name="categoriesId">
                                ...
                                while($row = mysqli_fetch_assoc($result)){?>
                                    ...
                                    <?php if($row['id'] == 2){echo "selected='true'";}else{echo false;} ?>>
