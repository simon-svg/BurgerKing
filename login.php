...
<body>
    ...
    <div class="container">
        <div class="row">
            <form class="form form-log-reg col-12" action="./php/login.php" method="POST" id="contactForm">
                ...
                <div>
                    <button class="btn custom-btn" type="submit" id="sendMessageButton">Login</button>
                </div>
            </form>
        </div>
    </div>
